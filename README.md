...
3. Open `http://localhost:5173` and try it out!
...
* The project uses [Vite](https://vite.dev/) as the build tool and dev server.
* The project is written in Javascript using [ES6](https://github.com/lukehoban/es6features) syntax.
...
* [React Router](https://reactrouter.com/) handles app navigation
* [AWS SDK for JavaScript v3](https://github.com/aws/aws-sdk-js-v3) as the AWS client library (API)
* [mqtt.js](https://github.com/mqttjs/MQTT.js) as the MQTT client (browser)
